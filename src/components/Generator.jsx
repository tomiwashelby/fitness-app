	...
	return (
		<SectionWrapper id={'generate'} header={"generate your workout"} title={["It's", "Huge", "o'clock"]} >
			...
			<div className="bg-slate-950 flex flex-col border border-solid border-blue-400 rounded-lg">
				<button onClick={toggleModal} className="relative px-4 py-3 flex items-center justify-center">
					...
					(scheme, schemeIndex) => {
						return (
							<button 
								...
								className={'bg-slate-950 border border-blue-400 duration-200 hover:border-blue-600 px-4 py-3 rounded-lg ' + (scheme === goal ? 'border-blue-600' : 'border-blue-400')} 
								key={schemeIndex}
							>
